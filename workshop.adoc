...
You will build the API Gateway for the _MusicStore_ using the following technologies.
...
* https://graphql.org/learn/[Introduction to GraphQL]
* https://www.graphql-java.com/documentation/v12/[GraphQL-Java documentation]
* https://vertx.io/docs/vertx-web-graphql/java/[Vert.x Web GraphQL documentation]
